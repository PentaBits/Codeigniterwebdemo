    ...
    <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-12">
				...
				<p class="what-info-tag"><a href="javascript:;" data-toggle="modal" data-target="#fitnessassessmentstrength">Know about general fitness assesment</a> <i class="fa fa-question-circle" aria-hidden="true" style="font-size:20px;"></i></p>
            </div>
        </div>
...
<div id="fitnessassessmentstrength" class="modal fade" role="dialog">
